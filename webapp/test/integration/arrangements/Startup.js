sap.ui.define([
	"sap/ui/test/Opa5",
	"com/company/salesorderapp/salesorderapp/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.company.salesorderapp.salesorderapp.test.integration.arrangements.Startup", {
