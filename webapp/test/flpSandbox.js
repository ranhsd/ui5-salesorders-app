		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales orders app",
									"targetURL": "#comcompanysalesorderappsalesorderapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcompanysalesorderappsalesorderapp-display": {
								"semanticObject": "comcompanysalesorderappsalesorderapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.company.salesorderapp.salesorderapp",
									"url": sap.ui.require.toUrl("com/company/salesorderapp/salesorderapp")
								}
							}
						}
					}
