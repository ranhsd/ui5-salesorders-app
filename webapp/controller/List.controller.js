sap.ui.define([
    ...
    "../model/formatter",
    "com/company/salesorderapp/salesorderapp/utils/common"
], function (BaseController, JSONModel, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, Fragment, formatter, utils) {
    "use strict";

    return BaseController.extend("com.company.salesorderapp.salesorderapp.controller.List", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "com.company.salesorderapp.salesorderapp.view.ViewSettingsDialog",
                    controller: this
        ...
        onConfirmViewSettingsDialog: function (oEvent) {
            ...
            aFilterItems.forEach(function (oItem) {
                switch (oItem.getKey()) {
                    case "Filter1":
                        aFilters.push(new Filter("customerId", FilterOperator.GE, utils.zeroPad(1, 9)));
                        break;
                    case "Filter2":
                        aFilters.push(new Filter("customerId", FilterOperator.LE, utils.zeroPad(100, 9)));
                        break;
                    default:
                        break;
                }
